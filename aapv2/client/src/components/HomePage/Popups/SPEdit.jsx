...
const EditPopUpForm = props => {
    ...
    const submitEdit = e =>{
        ...
        if(croppedImage.current && croppedImage.current.name){
            ...
            formData.append("firstName", updateShelter.firstName)
            formData.append("lastName", updateShelter.lastName)
            formData.append("email", updateShelter.email)
            ...
            console.log(updateShelter)
            axios.put("http://localhost:8000/api/user/edit",updateShelter)
                .then(res => {
                    window.location.replace(`/home`)
                })
